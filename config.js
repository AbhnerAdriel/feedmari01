...
const MENU_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ3Dx0HVHeB-itSKSUekt-P1IoRwb6Cejl80qrCliD5yLucElyacqyZS-3V53IwMHKZe6iDFxj-DeD/pub?gid=0&single=true&output=csv';

// URL of the spreadsheet with menu categories (tab: Categories)
const CATEGORIES_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ3Dx0HVHeB-itSKSUekt-P1IoRwb6Cejl80qrCliD5yLucElyacqyZS-3V53IwMHKZe6iDFxj-DeD/pub?gid=1625011645&single=true&output=csv';

// URL of the spreadsheet with general settings (tab: Config)
const CONFIG_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ3Dx0HVHeB-itSKSUekt-P1IoRwb6Cejl80qrCliD5yLucElyacqyZS-3V53IwMHKZe6iDFxj-DeD/pub?gid=938270169&single=true&output=csv';

// URL of the spreadsheet with operating hours (tab: Hours)
const HOURS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ3Dx0HVHeB-itSKSUekt-P1IoRwb6Cejl80qrCliD5yLucElyacqyZS-3V53IwMHKZe6iDFxj-DeD/pub?gid=2037052438&single=true&output=csv';

// URL of the spreadsheet with neighborhoods and delivery fees (tab: Bairros) **OPCIONAL**
const NEIGHBORHOODS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ3Dx0HVHeB-itSKSUekt-P1IoRwb6Cejl80qrCliD5yLucElyacqyZS-3V53IwMHKZe6iDFxj-DeD/pub?gid=199888105&single=true&output=csv';

// URL da planilha de cupons de desconto  **OPCIONAL**
const COUPONS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ3Dx0HVHeB-itSKSUekt-P1IoRwb6Cejl80qrCliD5yLucElyacqyZS-3V53IwMHKZe6iDFxj-DeD/pub?gid=964638752&single=true&output=csv';
